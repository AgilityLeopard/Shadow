...
var renderPerks = function () {
    ...
    for (var i = 0; i <= 9; ++i) {
        ...
        for (var j = 0; j < perks.length; ++j) {
            ...
            html += '<td><div data-placement="left" data-trigger="hover" data-original-title="' + perk.name + '" data-html="true" data-content="' + title + '" data-i="' + i + '" data-j="' + j + '" class="perk' + className + '" style="background-color: #25a912">';
